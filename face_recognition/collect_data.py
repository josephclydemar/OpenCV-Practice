...
TRAINING_DIR = './CapturedFaces/train'
VALIDATION_DIR = './CapturedFaces/val'

def capture_new_images(image_name: str, training_image_count=100, validation_image_count=30):
